				...
				chunks => {
					...
					for (const chunkA of chunks) {
						...
						loopB: for (const chunkB of chunkGraph.getModuleChunksIterable(
							...
							if (chunkAModulesCount > chunkBModulesCount) continue; // 如果 A 的模块数大于 B 的模块数，这时候 A 不可能在 B 里面
							...
							if ((chunkBHash & chunkAHash) !== chunkAHash) continue; // 如果不相同跳过
