...
class WebpackCLI {
    ...
    async run(args, parseOptions) {
        ...
        this.program.action(async (options, program) => {
            ...
            // parseAsync 是执行 commmandToRun 命令对应的回调函数，相当于是受理这个命令的调用；
            // parseAsync 就是解析字符串命令，然后去匹配该字符串对应的回调，然后执行他；
            // 而命令的 handler 函数则是在上面 loadCommandByName 中注册 command.action(cb) 注册
